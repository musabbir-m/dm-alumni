...
- `src/data/batches.ts` is still static data (real photos for 1st–7th, stock images for 8th–10th, estimate counts) to be replaced by MongoDB-backed data
